...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        <motion.div // Envuelve el contenido del encabezado en un motion.div
          className={`z-10 fixed ${
            showMenu ? "w-[80%] md:w-[40%] xl:w-[80%]" : "w-0"
          } gap-8 md:gap-16 top-16 transition-all duration-300 md:static flex-1 flex ${
            showMenu
              ? "flex-col h-screen bg-gradient-to-r from-purple-200 via-purple-400 to-purple-800 justify-center items-center"
              : ""
          } md:flex-wrap justify-end h-full items-end`}
          initial={{ opacity: 0, y: -100 }} // Establece las propiedades iniciales
          animate={{ opacity: 1, y: 0 }} // Establece las propiedades animadas
        >
          <div className="flex md:flex-wrap justify-center mr-20 items-center md:gap-8">
            <a
              href="#home"
              className="text-white font-medium text-xl text-center cursor-pointer hover:transition duration-300"
              onClick={scroll}
            >
              Stock
            </a>
            <a
              href="/about"
              className="text-white font-medium text-xl text-center cursor-pointer"
            >
              Nosotros
            </a>
            <a
        ...
        <button
          ...
          className="text-white md:hidden text-2xl p-3"
        >
