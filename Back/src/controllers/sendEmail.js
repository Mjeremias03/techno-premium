...
const sendEmail = async (req, res) => {
  try {
    ...
    const emailOptions = {
        ...
        <div style="flex: 1;">
        <p style="font-size: 24px; margin-bottom: 20px; color: #fff;">¡Bienvenido, ${name}!</p>
        <p style="font-size: 18px; color: #fff;">Te damos la bienvenida a nuestra plataforma.</p>
        <p style="font-size: 18px; color: #fff;">Estaremos en contacto para informarte sobre nuevas ofertas, adquisiciones, accesorios.</p>
        <p style="font-size: 18px; margin: 20px 0; color: #fff;">Si necesitas algo, no dudes en consultarnos. Estamos aquí para ayudarte con cualquier pregunta que tengas, ya sea sobre stock, servicios o cualquier otro tema.</p>
